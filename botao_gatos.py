...
def trofeu():
    while True:
        ...
        trofeu_TEXT = get_font(45).render("This is the PLAY screen.", True, "White")
        trofeu_RECT = trofeu_TEXT.get_rect(center=(640, 260))
        SCREEN.blit(trofeu_TEXT, trofeu_RECT)

        trofeu_BACK = Button(image=None, pos=(640, 460), 
                            text_input="BACK", font=get_font(75), base_color="White", hovering_color="Green")

        trofeu_BACK.changeColor(PLAY_MOUSE_POS)
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                sys.exit()
            if event.type == pygame.MOUSEBUTTONDOWN:
                if trofeu_BACK.checkForInput(PLAY_MOUSE_POS):
                    main_menu()
...
def rank():
    while True:
        ...
        rank_TEXT = get_font(45).render("This is the PLAY screen.", True, "White")
        rank_RECT = rank_TEXT.get_rect(center=(640, 260))
        SCREEN.blit(rank_TEXT, rank_RECT)

        rank_BACK = Button(image=None, pos=(640, 460), 
                            text_input="BACK", font=get_font(75), base_color="White", hovering_color="Green")

        rank_BACK.changeColor(PLAY_MOUSE_POS)
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                sys.exit()
            if event.type == pygame.MOUSEBUTTONDOWN:
                if rank_BACK.checkForInput(PLAY_MOUSE_POS):
                    main_menu()
...
def main_menu():
    ...
    while True:
        ...
        TROFEU_BUTTON = Button(image=trofeu_image, pos=(SCREEN.get_width() // 2 - 100, SCREEN.get_height() - 100),
                            text_input="", font=get_font(25), base_color="White", hovering_color="Green")

        RANK_BUTTON = Button(image=rank_image, pos=(SCREEN.get_width() // 2 + 100, SCREEN.get_height() - 100),
                            text_input="", font=get_font(25), base_color="White", hovering_color="Green")
