...
def enter_name(selected_cat, cat_image_path):
    ...
    while True:
        ...
        back_button = Button(image=None, 
                             ...
                             text_input=Traducoes[current_language]["return"], 
                             font=get_font(20), 
                             base_color="#940d35", 
                             hovering_color="Pink")
        back_button.changeColor(ENTER_MOUSE_POS)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if back_button.checkForInput(ENTER_MOUSE_POS):
                    return
...
def options(cats):
    ...
    while True:
        ...
        OPTIONS_BACK = Button(image=None, pos=(SCREEN.get_width() - 70, SCREEN.get_height() - 30), 
                              text_input=Traducoes[current_language]["return"], font=get_font(20), base_color="#940d35", hovering_color="Pink")
        APPLY_BUTTON = Button(image=None, pos=(SCREEN.get_width() // 2, SCREEN.get_height() - 65),
                              text_input=Traducoes[current_language]["apply"], font=get_font(20), base_color="#301934", hovering_color="#6A0DAD")
